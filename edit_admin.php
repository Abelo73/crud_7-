...
if(isset($_POST['update'])){
    ...
    if ($password_1 != $password_2) {
        ...
        $update = "UPDATE admin_table SET id =$id, fullname ='$fullname', email = '$email',user_type='$user_type',mobile='$mobile',bank_account='$bank_account',age ='$age',password ='$password_1' where id = $id";
