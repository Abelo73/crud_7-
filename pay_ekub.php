...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO pay_ekub_money(fullname,mobile,reciver_name,reciver_account,amount)  values('$fullname','$mobile','$reciver_name','$reciver_account','$amount')";
    $result = mysqli_query($conn, $sql);
    if ($result) {
        $messages[] = "Payment  done successfuly";
        header('location:view_ekub_transaction.php');
    } else {
...
<html lang="en">
    ...
    <body>
        <div class="container my-5 shadow p-3">
            <h3 class="text-center text-dark text-uppercase">Pay Ekub Money</h3>
